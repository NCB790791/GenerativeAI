...
function createGlueDatabase(scope, databaseProps) {
    const _mergedDBProps = (databaseProps !== undefined) ? (0, utils_1.overrideProps)(defaults.DefaultGlueDatabaseProps(), databaseProps) :

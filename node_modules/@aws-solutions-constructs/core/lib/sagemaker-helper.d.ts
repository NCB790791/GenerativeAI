 ...
 */
export declare function buildSagemakerNotebook(scope: Construct, id: string, props: BuildSagemakerNotebookProps): BuildSagemakerNotebookResponse;
 ...
 * @internal This is an internal core function and should not be called directly by Solutions Constructs clients.
 */
export declare function BuildSagemakerEndpoint(scope: Construct, id: string, props: BuildSagemakerEndpointProps): BuildSagemakerEndpointResponse;
 ...
 * @internal This is an internal core function and should not be called directly by Solutions Constructs clients.
 */
export declare function deploySagemakerEndpoint(scope: Construct, id: string, props: BuildSagemakerEndpointProps): DeploySagemakerEndpointResponse;
/**
 * @internal This is an internal core function and should not be called directly by Solutions Constructs clients.
 */
 ...
 * @internal This is an internal core function and should not be called directly by Solutions Constructs clients.
 */
export declare function createSagemakerEndpointConfig(scope: Construct, id: string, modelName: string, endpointConfigProps?: sagemaker.CfnEndpointConfigProps): sagemaker.CfnEndpointConfig;
/**
 * @internal This is an internal core function and should not be called directly by Solutions Constructs clients.
 */
...
export declare function CheckSagemakerProps(propsObject: SagemakerProps | any): void;
